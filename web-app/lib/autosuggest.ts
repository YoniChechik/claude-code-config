...
/**
 * Autosuggest logic ported from autosuggest.sh
 * Provides slash command suggestions with fuzzy matching
 */
 ...
 * Ported from fuzzy_score function (lines 294-302)
 */
function fuzzyScore(pattern: string, candidate: string): number {
