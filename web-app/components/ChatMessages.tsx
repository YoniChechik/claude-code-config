...
export default function ChatMessages({
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 pl-12 space-y-6 bg-gradient-to-b from-gray-900 to-gray-900">
      ...
      {visibleMessages.map((message, index) => (
        <div
          key={index}
          className={`flex flex-col gap-2 p-4 pl-6 rounded-2xl shadow-sm transition-all duration-200 hover:shadow-md ${
            message.role === "user"
      ...
      {/* Streaming message */}
      {isStreaming && (
        <div className="flex flex-col gap-2 p-4 pl-6 rounded-2xl shadow-sm bg-gray-800 border border-gray-700 text-gray-100 mr-auto max-w-[85%]">
