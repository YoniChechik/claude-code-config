...
95% of the time, the user asks you to implement a feature ("build X", "add X feature", "implement X", "create X", "let's start working on X") — anything beyond a trivial one-file edit.
