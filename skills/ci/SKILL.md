...
The watcher writes notifications to `~/.claude/channel/inbox` (one line per message).
The MCP webhook server watches that file and relays each line as a channel notification.
